...
python run_language_model.py --output_dir ./BERToni  --model_type roberta   --mlm --tokenizer_dir BERTokens--do_train --learning_rate 1e-4 --num_train_epochs 5 --save_total_limit 2 --save_steps 2000 --per_gpu_train_batch_size 4  --seed 42 --train_data_file training.txt
...
def main():
    ...
    if model_args.tokenizer_name:
        logger.log(1,"...................."+model_args.tokenizer_name)
    ...
    if data_args.block_size <= 0:
        data_args.block_size = tokenizer.model_max_length#tokenizer.max_len
